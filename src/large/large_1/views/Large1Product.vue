<template>
    <div class="bg-black h-[calc(100vh-70px)] w-screen">
        <div class="px-4 sm:container mx-auto h-full">
            <div class="flex justify-between items-center h-full w-full">
                ...
                <div class="hidden md:block md:w-[40%] py-6 h-full">
                    <img class="h-full w-full rounded-tr-[100px] rounded-bl-[100px]" 
                        src="../assets/img/image_desktop.png" alt="">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-black">
        <div class="px-4 py-16 sm:container mx-auto">
            <div class="flex flex-col gap-y-4 md:justify-between md:flex-row md:items-center">
                ...
                <!-- <a href="" class="bg-white py-3 px-12 rounded-md text-black text-center font-semibold">
